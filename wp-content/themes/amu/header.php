...
<header class="site-header">
	<div class="wrap nav-inner">
		...
		<div class="nav-actions">
			...
			<a class="btn-subscribe" href="<?php echo esc_url( amu_subscribe_url() ); ?>"><?php esc_html_e( 'Subscribe', 'amu' ); ?></a>
		</div>
	</div>
</header>
...
<div class="mobile-drawer" id="amuDrawer" aria-hidden="true">
	<div class="wrap" style="width:100%">
		...
		<a class="drawer-sub" href="<?php echo esc_url( amu_subscribe_url() ); ?>"><?php esc_html_e( 'Subscribe', 'amu' ); ?></a>
	</div>
</div>
